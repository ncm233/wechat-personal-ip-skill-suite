...
Source group: `DAN KOE` / `thedankoe`
Sample count: 7

## 1. 总体风格定位
- 这是一个从 `DAN KOE` 样本中自动蒸馏出的文章风格草案，适合继续人工或 AI 二次精修。
- 样本标题平均长度约 16.0 字，正文开头段落中位长度约 21 字，整体偏向 短段落高节奏。
- 该组内容的高频标题信号包括：如何用、天时间彻底重塑你的人生、如果你兴趣广泛、请别浪费未来、年的时间、如何进行有深度的表达、如何变得极具创造力、甚至让人感到、违规、人生是一场心理博弈、教你如何胜出、我恳求你多写写文章。
- 写作目标应优先复刻其标题钩子、开头承诺、段落节奏和可收藏结构，而不是复述样本主题。

## 2. 标题风格
- 常见标题结构：主体/结果前置、问题承诺、方法清单、强判断或教程型标题。
- 标题里的高频词：如何用、天时间彻底重塑你的人生、如果你兴趣广泛、请别浪费未来、年的时间、如何进行有深度的表达、如何变得极具创造力、甚至让人感到、违规、人生是一场心理博弈、教你如何胜出、我恳求你多写写文章。
- 标题制造点击欲的方式：数字标题 3 篇，问句标题 0 篇，感叹标题 0 篇，冒号/栏目式标题 0 篇；优先把读者收益、结果、身份或场景放到标题前半段。
...
## 4. 正文结构
- 段落长度：开头样本段落均值约 35 字，中位数约 21 字。
- 小标题习惯：常见小标题示例包括：Original; 如何用 1 天时间彻底重塑你的人生; I – 你没有达到想要的位置，因为你还不是那种能达到的人; II – 你没有达到想要的位置，因为你不想在那里; III – 你没有达到想要的位置，因为你害怕在那里; IV – 你想要的生活存在于特定的心智层面。
...
## 样本文件
- 0001-fix-your-life-one-day.md
- 0002-multiple-interests-career-guide.md
- 0003-how-to-articulate-yourself-intelligently.md
- 0019-how-to-become-insanely-creative.md
- 0039-win-the-life-mind-game.md
- 0067-write-essays-to-save-thinking.md
- 0219-fix-your-life-one-day.md
