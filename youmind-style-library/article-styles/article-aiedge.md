...
Source group: `AI Edge` / `aiedge_`
Sample count: 7

## 1. 总体风格定位
- 这是一个从 `AI Edge` 样本中自动蒸馏出的文章风格草案，适合继续人工或 AI 二次精修。
- 样本标题平均长度约 22.1 字，正文开头段落中位长度约 34 字，整体偏向 中长段信息推进。
- 该组内容的高频标题信号包括：AI、技能、Claude、如何投资、在淘金热中获利、个让你在、年实现财富自由的、如果我想在、年通过、致富、我会这样做、款顶级。
- 写作目标应优先复刻其标题钩子、开头承诺、段落节奏和可收藏结构，而不是复述样本主题。

## 2. 标题风格
- 常见标题结构：主体/结果前置、问题承诺、方法清单、强判断或教程型标题。
- 标题里的高频词：AI、技能、Claude、如何投资、在淘金热中获利、个让你在、年实现财富自由的、如果我想在、年通过、致富、我会这样做、款顶级。
- 标题制造点击欲的方式：数字标题 4 篇，问句标题 0 篇，感叹标题 0 篇，冒号/栏目式标题 1 篇；优先把读者收益、结果、身份或场景放到标题前半段。
...
## 4. 正文结构
- 段落长度：开头样本段落均值约 36 字，中位数约 34 字。
- 小标题习惯：常见小标题示例包括：Original; 结语; 最后的话; Final Thoughts; Closing; Claude Skills 2.0。
...
## 样本文件
- 0021-how-to-invest-in-ai.md
- 0026-7-ai-skills-wealth-2026.md
- 0166-get-rich-with-ai-2026.md
- 0277-top-12-claude-mcp-guide.md
- 0344-ai-bubble-bursting-financial-strategy.md
- 0361-how-to-automate-your-life.md
- 0828-claude-skills-ultimate-guide-2026.md
